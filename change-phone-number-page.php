...
<html>
<head>
	<title>Change number Page</title>
</head>
<body>
...
<link href="https://fonts.googleapis.com/css2?family=Anton&family=Cormorant+Garamond:ital,wght@0,400;1,300;1,400&family=Lobster&family=Lora:ital,wght@0,600;0,700;1,400;1,500;1,700&family=Montserrat:wght@100;200;300;400;500;600;700;900&family=Poppins:wght@100;200;300;400;500;600;900&family=Quicksand:wght@300;400;500;600;700&family=Raleway:ital,wght@0,100;0,200;0,300;0,400;1,100;1,200;1,300&display=swap" rel="stylesheet">
    ...
    <div class="wrapper">
            <section class="form change-number">
                <header>Change Phone number</header>
                <form action="#">
                  <div class="error-txt"></div>

                  <div class="field" >
                    <label for="phone-number">Former Phone Number:</label>
                    <input type="tel" pattern="\d{2} \d{2} \d{2} \d{2} \d{2}" placeholder="Phone Number" id="phone-number" name="formerphonenumber" required><br>
                  </div>
                  <div class="field" >
                    <label for="phone-number"> New Phone Number:</label>
                    <input type="tel" pattern="\d{2} \d{2} \d{2} \d{2} \d{2}" placeholder="Phone Number" id="new-phone-number" name="newphonenumber" required><br>
                  </div>
    ...
    <script src="change-number.js"></script>
