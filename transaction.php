...
echo '<table>';
echo '<tr><th>Date</th><th>Transaction Type</th><th>Amount</th><th>Phone Number</th><th>Transaction Number</th></tr>';
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    // Echo the table row
    echo "<tr><td>$date</td><td>$transaction_type</td><td>{$row['amount']} FCFA</td><td>$phone_number</td><td>{$row['transaction_number']}</td></tr>";
}
